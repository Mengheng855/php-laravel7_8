...
<body>
  <main class="auth-page">
    <section class="auth-shell" aria-label="Login form">
      <div class="auth-visual">
        ...
        <img src="../assets/images/ecommerce/product-1.jpg" alt="Featured laptop setup">
        <div class="visual-copy">
          <p>Welcome back</p>
          <h1>Sign in to shop faster.</h1>
          <p>Access your saved products, checkout details, and computer setup recommendations.</p>
        </div>
      </div>
        ...
        <form action="#" method="post">
          ...
          <div class="form-options">
            <label class="form-check d-flex align-items-center gap-2 m-0">
              <input class="form-check-input m-0" type="checkbox" name="remember">
