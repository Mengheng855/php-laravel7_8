  ...
  onReady(function () {
    ...
    function initUserProfile() {
      ...
      var user = window.adminHMDUser || {
        name: sidebarNameEl ? sidebarNameEl.textContent : "Admin Hasan",
        workspace: sidebarWorkspaceEl ? sidebarWorkspaceEl.textContent : "Active Workspace",
        avatar: sidebarAvatar ? sidebarAvatar.getAttribute("src") : "../assets/images/avatar/avatar.jpg"
      };
