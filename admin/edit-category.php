...
?>
          ...
          <section class="row g-3">
            <div class="col-12">
              <form action="updateCategory.php" method="post" class="panel needs-validation" novalidate>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control" value="<?= $row['cate_name'] ?>" name="categoryName" id="categoryName" type="text" required>
                ...
                <div class="d-flex flex-wrap justify-content-end gap-2 mt-4">
                  ...
                  <button class="btn btn-primary" type="submit" name="btnSubmit">
                    <i class="bi bi-check-circle" aria-hidden="true"></i> Update Category
                  </button>
                </div>
              </form>
            </div>
