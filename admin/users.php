...
?>
          <div class="page-heading">
            ...
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="tables.php"><i
                  class="bi bi-download" aria-hidden="true"></i> Export</a><a class="btn btn-primary btn-sm"
                href="add-user.php"><i class="bi bi-person-plus" aria-hidden="true"></i> Add User</a></div>
          </div>
          ...
          <section class="panel mt-3">
            <div class="panel-header">
              ...
              <div class="d-flex align-items-center gap-2 flex-grow-1 justify-content-end">
                ...
                <a class="btn btn-primary btn-sm text-nowrap" href="add-user.php"><i class="bi bi-person-plus"
...
<?php
$footer_subtext = "User management dashboard.";
